# Picovoice SDK for Arduino boards - Polish language
...
1. Compile and upload the `Picovoice_PL/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
